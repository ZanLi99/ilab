...
st.subheader('Some of the Industries covered by this award include', help = 'To help find out what industry you are in use [Fair Work sumamry](https://www.fairwork.gov.au/employment-conditions/awards/awards-summary/ma000009-summary)')
...
employment_stream = ['Food and beverage', 'Kitchen', 'Guest Service', 'Admininistration', 'Security', 'Leisure Activities Stream',  'Stores Stream','Maintenance and Trades' ]
...
'Kitchen' :{'Kitchen attendant grade 1 ': ['General cleaning duties or food preperation, assisting employees that are cooking, assembling ingredients, general pantry duties',  Adult_minimum_rate_weekly['level_1']],
...
'Admininistration': { 'Clerical level 1': ['Who is required to perform basic clerical and routine office duties such as collating, filing, photocopying and delivering messages.',  Adult_minimum_rate_weekly['level_2']],
                     'Clerical level 2': ['Employee who is engaged in general clerical or office duties, such as typing, filing, basic data entry and calculating functions.',  Adult_minimum_rate_weekly['level_3']],
                     'Clerical level 3': ['Has the appropriate level sof training, retrieves data through a computer terminal, keeps appropriate records, maintains mail register and records',  Adult_minimum_rate_weekly['level_4']],
...
'Leisure Activities Stream': { 'Leisure attendant grade 1;': ['Person who acts as an assistant instructor or pool attendant or is responsible for the setting up, distribution and care of equipment and the taking of bookings.',  Adult_minimum_rate_weekly['level_2']],
                                ...
                                'Leisure attendant grade 3': ['Person who has the appropriate level of training and who plans and co-ordinates leisure activities for guests and may supervise other leisure attendant',  Adult_minimum_rate_weekly['level_4']], },
...
'Stores Stream': { 'Storeperson grade 1': ['Employee who receives and stores general and perishable goods and cleans the store area.',  Adult_minimum_rate_weekly['level_2']],
                            ...
                            'Storeperson grade 3;': ['Appropriate levels of training, implements quality control techinuqes or precedures, responsible for a store or warehouse area, supervise and gives directions to employess. ',  Adult_minimum_rate_weekly['level_4']],},
...
job_type_2 = st.selectbox('Which of the following best describes your position',Job_information[stream] , help='For more information go to [Award](https://library.fairwork.gov.au/award/?krn=MA000009) ')
with st.expander('This is some of your job expectations'):
